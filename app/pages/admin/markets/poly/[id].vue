...
const sortBy = ref<'mentions' | 'mentions_asc' | 'percentage' | 'alpha'>('mentions')
...
<div class="max-w-7xl">
  ...
  <template v-else>
    ...
    <template v-else>
      ...
      <!-- With persona analysis: table layout -->
      <template v-if="selectedPersonaId">
        <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
          <!-- Table header -->
          <div class="hidden md:grid grid-cols-[1fr_80px_180px_70px_60px_60px_60px] gap-2 px-3 py-2 text-xs font-medium text-gray-500 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
            <span>Term</span>
            <span class="text-right">% Briefings</span>
            <span>Trend</span>
            <span class="text-right">Mentions</span>
      ...
      <div v-else class="gap-5 grid grid-cols-2">
